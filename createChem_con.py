...
chem_tempFile = open(sys.argv[2], 'r')  #r'C:\NCSU_MGIST_Portofolio_Archive\GIS590\Project\Data\chem_con_template.csv'
...
for id in epa_IDs:
    for row in chemRead:
        ...
        cellsdeepCleaned = [cell.strip('"') for cell in cellsCleaned]
        cellsdeepCleaned.insert(0,id)
        chem_conWrite.writerow(cellsdeepCleaned)
